        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReportsToUserId = table.Column<int>(type: "integer", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectMembers", x => new { x.ProjectMembersId, x.ProjectsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMembers_Users_ProjectMembersId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Priority = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: false),
